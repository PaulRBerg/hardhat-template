...
sedi "/gitpod/ s|paulrberg/hardhat-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gitpod-badge/ s|paulrberg/hardhat-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha/ s|paulrberg/hardhat-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha-badge/ s|paulrberg/hardhat-template|"${GITHUB_REPOSITORY}"|;" "README.md"
